...
import arrow_back from "../../assets/icons/arrowBack.svg"
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "data-[state=open]:animate-in bg-transparent  data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed bottom-0 left-[50%] z-50 grid w-full translate-x-[-50%] gap-1 shadow-lg duration-200 h-[440px]",
          className
        )}
        {...props}
      >
